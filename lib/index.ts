 ...
 * @typedef {ZalgoOptions} ZalgoOptions Options for the Zalgo
 ...
 * @typedef {ZalgoCountsMap} ZalgoCountsMap
 * @property {number} up
 ...
 * @name zalgo
 */
export const zalgo = (text: string, options: ZalgoOptions = { up: true, middle: true, down: true, size: '' }): string => {
    try {
